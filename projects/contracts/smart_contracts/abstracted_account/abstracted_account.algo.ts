...
import { FullPluginValidation, MethodInfo, MethodRestriction, MethodValidation, PluginInfo, PluginsKey, PluginValidation } from './types';

export class AbstractedAccount extends Contract {

  /** The admin of the abstracted account. This address can add plugins and initiate rekeys */
  admin = GlobalState<Account>({ key: ADMIN_KEY });
   ...
   */
  plugins = BoxMap<PluginsKey, PluginInfo>({ keyPrefix: PLUGINS_BOX_PREFIX });

  /**
   * Plugins that have been given a name for discoverability
   */
  namedPlugins = BoxMap<string, PluginsKey>({ keyPrefix: NAMED_PLUGINS_BOX_PREFIX });
