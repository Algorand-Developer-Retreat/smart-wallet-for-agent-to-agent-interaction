...
export const APP_SPEC: Arc56Contract = {"name":"MarketplacePlugin","structs":{},"methods":[{"name":"hello","args":[{"type":"string","name":"name"}],"returns":{"type":"string"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"events":[],"recommendations":{}}],"arcs":[22,28],"networks":{},"state":{"schema":{"global":{"ints":0,"bytes":0},"local":{"ints":0,"bytes":0}},"keys":{"global":{},"local":{},"box":{}},"maps":{"global":{},"local":{},"box":{}}},"bareActions":{"create":["NoOp"],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[25],"errorMessage":"OnCompletion is not NoOp"},{"pc":[66],"errorMessage":"can only call when creating"},{"pc":[28],"errorMessage":"can only call when not creating"}],"pcOffsetMethod":"none"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}},"source":{"approval":"","clear":"I3ByYWdtYSB2ZXJzaW9uIDEwCiNwcmFnbWEgdHlwZXRyYWNrIGZhbHNlCgovLyBAYWxnb3JhbmRmb3VuZGF0aW9uL2FsZ29yYW5kLXR5cGVzY3JpcHQvYmFzZS1jb250cmFjdC5kLnRzOjpCYXNlQ29udHJhY3QuY2xlYXJTdGF0ZVByb2dyYW0oKSAtPiB1aW50NjQ6Cm1haW46CiAgICBwdXNoaW50IDEgLy8gMQogICAgcmV0dXJuCg=="},"byteCode":{"approval":"CjEbQQA0gAQCvs4RNhoAjgEAA4EAQzEZFEQxGEQ2GgFXAgCIACBJFRZXBgJMUIAEFR98dUxQsIEBQzEZQP/UMRgURIEBQ4oBAYAHSGVsbG8sIIv/UIk=","clear":"CoEBQw=="},"compilerInfo":{"compiler":"puya","compilerVersion":{"major":4,"minor":5,"patch":3}},"events":[],"templateVariables":{}} as unknown as Arc56Contract
...
export type MarketplacePluginTypes = {
  ...
  methods:
    & Record<'hello(string)string' | 'hello', {
      argsObj: MarketplacePluginArgs['obj']['hello(string)string']
      argsTuple: MarketplacePluginArgs['tuple']['hello(string)string']
      returns: MarketplacePluginReturns['hello(string)string']
    }>
}
...
export abstract class MarketplacePluginParamsFactory {
   ...
   */
  static hello(params: CallParams<MarketplacePluginArgs['obj']['hello(string)string'] | MarketplacePluginArgs['tuple']['hello(string)string']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
...
export class MarketplacePluginClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the MarketplacePlugin smart contract using the `hello(string)string` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    hello: (params: CallParams<MarketplacePluginArgs['obj']['hello(string)string'] | MarketplacePluginArgs['tuple']['hello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.params.call(MarketplacePluginParamsFactory.hello(params))
    },
  ...
  readonly createTransaction = {
     ...
     */
    hello: (params: CallParams<MarketplacePluginArgs['obj']['hello(string)string'] | MarketplacePluginArgs['tuple']['hello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.createTransaction.call(MarketplacePluginParamsFactory.hello(params))
    },
  ...
  readonly send = {
     ...
     */
    hello: async (params: CallParams<MarketplacePluginArgs['obj']['hello(string)string'] | MarketplacePluginArgs['tuple']['hello(string)string']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(MarketplacePluginParamsFactory.hello(params))
      return {...result, return: result.return as unknown as (undefined | MarketplacePluginReturns['hello(string)string'])}
    },
  ...
  public newGroup(): MarketplacePluginComposer {
    ...
    return {
      /**
       * Add a hello(string)string method call against the MarketplacePlugin contract
       */
      hello(params: CallParams<MarketplacePluginArgs['obj']['hello(string)string'] | MarketplacePluginArgs['tuple']['hello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
...
export type MarketplacePluginComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  hello(params?: CallParams<MarketplacePluginArgs['obj']['hello(string)string'] | MarketplacePluginArgs['tuple']['hello(string)string']>): MarketplacePluginComposer<[...TReturns, MarketplacePluginReturns['hello(string)string'] | undefined]>
